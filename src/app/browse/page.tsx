...
import { Layers, ChevronDown, BookMarked } from "lucide-react";
...
export default function BrowsePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      {/* Premium Header */}
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-12 bg-card p-8 rounded-3xl shadow-sm border border-border">
        ...
        {Object.values(structure).map((sec, secIdx) => (
          <div key={sec.section} className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4">
              {Object.values(sec.chapters).map((chap, chapIdx) => {
